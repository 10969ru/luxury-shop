...
export default function LoginPage() {
  ...
  const handleSignUp = async () => {
    ...
    if (signUpError) {
      showMessage(signUpError.message.includes("already registered") ? MESSAGES.SIGNUP_EXISTS : `${MESSAGES.AUTH_ERROR}\n${signUpError.message}`);
      return;
    }
    ...
    if (data.user) {
      ...
      if (profileError) console.error("プロフィール作成失敗:", profileError);
    }
