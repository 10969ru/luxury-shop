  ...
  const handlePurchase = async () => {
    ...
    const historyItems = cart.map((item: any) => {
      ...
      return {
        ...
        image_url: item.detailImg || item.detail_img || productData?.detailImg || "",
    ...
    if (clearCartError) {
      console.error("カート削除エラー詳細:", clearCartError);
      showMessage("カートの削除に失敗しました。");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 pt-32 text-center">
      ...
      <div className="max-w-md mx-auto space-y-4 mb-12">
        ...
        <div className="border-t border-zinc-800 pt-4 text-xl">
      ...
      <div className="flex justify-center gap-8">
        <button
          onClick={() => router.back()}
          className="px-8 py-3 border border-zinc-500 text-zinc-500"
        >
          NO
        </button>
